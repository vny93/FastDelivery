...
interface ApiWayService {
    ...
    fun checkWayExist(@Header("Authorization") BearerToken: String, @Body req: CheckWayExistReq):Call<MainWarehouseRes>

    @POST("v2/way/update")
    fun update(@Header("Authorization") BearerToken: String, @Body req: UpdateWayReq):Call<UpdateRes>
