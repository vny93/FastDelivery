...
import vn.vunganyen.fastdelivery.databinding.ActivityShopChangePwBinding

class ShopChangePwActivity : AppCompatActivity(), ShopChangePwItf {
    lateinit var binding : ActivityShopChangePwBinding
    lateinit var shopChanePwPst: ShopChanePwPst
    var dialog : StartAlertDialog = StartAlertDialog()
    var md5 : MD5Hash = MD5Hash()
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityShopChangePwBinding.inflate(layoutInflater)
        setContentView(binding.root)
        shopChanePwPst = ShopChanePwPst(this)
        setToolbar()
        setEvent()
    }
    ...
    fun setEvent(){
        binding.btnChangePass.setOnClickListener{
            ...
            shopChanePwPst.validCheck(curentPw,password1,password2)
        }
